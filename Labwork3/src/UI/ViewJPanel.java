...
public class ViewJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 80, 320, 290));
        ...
        add(viewObservationBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 410, -1, -1));

        fieldObservationId.setEnabled(false);
        add(fieldObservationId, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 110, 100, -1));
        add(fieldTemperature1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 180, 100, -1));
        add(fieldBooldPressure, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, 100, -1));
        ...
        jLabel4.setText("VIEW AND UPDATE A VITAL SIGN");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, 270, 40));
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        if (!fieldObservationId.getText().isEmpty()) {
            ...
            o.setBloodPressure(Double.valueOf(fieldBooldPressure.getText()));
...
//            this.selectedObservation.setBloodPressure(Double.valueOf(fieldBooldPressure.getText()));
//            this.selectedObservation.setTemperature(Double.valueOf(fieldTemperature1.getText()));
    ...
    private void viewObservationBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewObservationBtnActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            fieldBooldPressure.setText(String.valueOf(this.selectedObservation.getBloodPressure()));
